# Noonan-Syndrom - Klinische Diagnose - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2026.0.1
...
> **evidence****code**: Hypertelorism**detail**: [Observation Hypertelorism](Observation-hypertelorism.md)

> **evidence****code**: Anteverted nares**detail**: [Observation Anteverted nares](Observation-anteverted-nares.md)

> **evidence****code**: Ventricular septal defect**detail**: [Observation Ventricular septal defect](Observation-vsd.md)

> **evidence****code**: Lymphedema**detail**: [Observation Lymphedema](Observation-lymphedema.md)
...
```json
{
  ...
  "id" : "example-noonan-clinical-diagnosis",
  "meta" : {
