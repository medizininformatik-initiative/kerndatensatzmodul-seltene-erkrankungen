...
| [ Beispiel Geschlecht bei Geburt — nicht bestimmbar  ](Observation-mii-exa-seltene-geschlecht-bei-geburt-indeterminate.md) | Der Fall, für den dieses Profil überhaupt SNOMED CT statt der LOINC-Antwortliste bindet: bei Geburt nicht bestimmbares Geschlecht. LOINC LL3324-2 böte hier nur 'Unknown' an, was etwas anderes heißt — nicht erhoben statt nicht bestimmbar. Störungen der Geschlechtsentwicklung sind selbst seltene Erkrankungen und damit Kerngeschäft dieses Moduls. |
| [ Beispiel Geschlecht bei Geburt — weiblich  ](Observation-mii-exa-seltene-geschlecht-bei-geburt.md) | Biologisches Geschlecht bei Geburt für das SMA-Neugeborene. Deckt sich hier mit dem administrativen Patient.gender; der Sinn des eigenen Datenpunkts zeigt sich erst im Fall daneben. |
