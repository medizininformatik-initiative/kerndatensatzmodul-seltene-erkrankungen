# Mukoviszidose - Nach positivem Screening ausgeschlossen - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2026.0.1
...
| :--- | :--- | :--- |
| - | **Code** | **Detail** |
| * | Genetic finding | [Observation/molgen-cftr-heterozygous-carrier](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.5.4&canonical=http://fhir.org/packages/de.basisprofil.r4/Observation/molgen-cftr-heterozygous-carrier) |
