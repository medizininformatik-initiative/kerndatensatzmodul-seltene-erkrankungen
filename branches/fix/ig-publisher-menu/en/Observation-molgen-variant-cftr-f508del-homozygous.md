# CFTR F508del Homozygot - MolGen Variante - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2026.0.1

## Example Observation: CFTR F508del Homozygot - MolGen Variante
...
```json
{
  ...
  "id" : "molgen-variant-cftr-f508del-homozygous",
  "status" : "final",
  "category" : [{
    "coding" : [{
