# Ehlers-Danlos-Syndrom - Ausgeschlossen - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2026.0.1
...
| :--- | :--- | :--- |
| - | **Code** | **Detail** |
| * | Beighton-Score niedrig | [Observation/beighton-score-low](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.5.4&canonical=http://fhir.org/packages/de.basisprofil.r4/Observation/beighton-score-low) |
