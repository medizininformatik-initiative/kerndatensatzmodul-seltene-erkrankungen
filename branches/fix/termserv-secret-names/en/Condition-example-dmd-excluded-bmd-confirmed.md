# Duchenne ausgeschlossen - Becker bestätigt - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Duchenne ausgeschlossen - Becker bestätigt**

## Example Condition: Duchenne ausgeschlossen - Becker bestätigt
...
| :--- | :--- | :--- |
| - | **Code** | **Detail** |
| * | Genetic finding | [Observation/molgen-dmd-in-frame-deletion](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.5.4&canonical=http://fhir.org/packages/de.basisprofil.r4/Observation/molgen-dmd-in-frame-deletion) |
...
```json
{
  ...
  "id" : "example-dmd-excluded-bmd-confirmed",
  "meta" : {
