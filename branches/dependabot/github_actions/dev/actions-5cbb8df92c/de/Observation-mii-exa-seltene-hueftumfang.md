...
## Beispiel Observation: Hüftumfang Beispiel
...
Profile: [MII PR SE Hüftumfang](StructureDefinition-mii-pr-seltene-hueftumfang.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-seltene/StructureDefinition/mii-pr-seltene-hueftumfang|2027.0.0-ballot"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
