# Katarakt bilateral - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Katarakt bilateral**

## Example Condition: Katarakt bilateral
...
**encounter**: [Encounter: status = finished; class = ambulatory (ActCode#AMB); type = Ophthalmic examination and evaluation; period = 2024-10-15 --> 2024-10-15](Encounter-mii-exa-seltene-encounter-ophthalmology.md)
...
| :--- | :--- | :--- |
| - | **Code** | **Detail** |
| * | Cataract | [Observation Cataract](Observation-mii-exa-seltene-symptom-cataract.md) |
