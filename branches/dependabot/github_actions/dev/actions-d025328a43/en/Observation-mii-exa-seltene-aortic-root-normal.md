# Aortenwurzel - Normalbefund - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Aortenwurzel - Normalbefund**

## Example Observation: Aortenwurzel - Normalbefund
...
```json
{
  ...
  "id" : "mii-exa-seltene-aortic-root-normal",
  "status" : "final",
  "category" : [{
    "coding" : [{
