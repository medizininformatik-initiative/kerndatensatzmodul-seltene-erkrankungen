...
## Beispiel Condition: Hereditäres Mamma- und Ovarialkarzinom-Syndrom
...
> **evidence****code**: Genetic finding**detail**: [Observation Genetic variant assessment](Observation-mii-exa-seltene-molgen-variant-brca1-pathogenic.md)

> **evidence****code**: Genetic test**detail**: [Diagnostic Report for 'Master HL7 genetic variant reporting panel' for '->Max Mustermann (official) Male, DoB: 1990-01-01 ( http://test-krankenhaus.de/fhir/sid/patienten#12345)'](DiagnosticReport-mii-exa-seltene-molgen-brca-panel.md)
