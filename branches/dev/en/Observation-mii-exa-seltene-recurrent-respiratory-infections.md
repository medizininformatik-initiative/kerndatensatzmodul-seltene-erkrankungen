# Rezidivierende Atemwegsinfekte - HPO-kodiert - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Rezidivierende Atemwegsinfekte - HPO-kodiert**

## Example Observation: Rezidivierende Atemwegsinfekte - HPO-kodiert
...
```json
{
  ...
  "id" : "mii-exa-seltene-recurrent-respiratory-infections",
  "meta" : {
