# Downloads - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot.rc1
...
Diese Seite verlinkt die herunterladbaren Artefakte des Moduls **Seltene Erkrankungen**.
...
* [ImplementationGuide-Ressource](ImplementationGuide-mii-ig-seltene.md)
...
Über die oben aufgeführten hinaus bietet das Modul keine Downloads an. Jeder Link dieser Seite wurde gegen den publizierten Build geprüft; die Beispiel-Bundles der beiden Fallbeispiele stecken in `examples.json.zip` und `examples.xml.zip`.
