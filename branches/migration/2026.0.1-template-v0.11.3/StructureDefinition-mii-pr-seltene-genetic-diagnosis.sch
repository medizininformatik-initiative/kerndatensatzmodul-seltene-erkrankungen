...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile MII_PR_Diagnose_Condition
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:onset[x]/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:Condition/f:onset[x]/f:extension/f:value[x]">
      <sch:assert test="count(f:coding) &gt;= 1">coding: minimum cardinality of 'coding' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:evidence/f:code</sch:title>
