...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-seltene/StructureDefinition/mii-ex-seltene-genetic-basis | *Version*:2027.0.0-ballot |
| Active Stand: 2026-08-28 | *Maschinenlesbarer Name*:GeneticBasis |
...
Simple Extension with the type CodeableConcept: Extension to describe the genetic basis of a rare disease
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-ex-seltene-genetic-basis.csv), [Excel](../StructureDefinition-mii-ex-seltene-genetic-basis.xlsx), [Schematron](../StructureDefinition-mii-ex-seltene-genetic-basis.sch) 
