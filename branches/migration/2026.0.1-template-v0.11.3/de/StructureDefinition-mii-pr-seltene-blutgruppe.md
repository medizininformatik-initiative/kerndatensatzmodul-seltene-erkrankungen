...
## Ressourcenprofil: MII PR SE Blutgruppe 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-seltene/StructureDefinition/mii-pr-seltene-blutgruppe | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-03 | *Maschinenlesbarer Name*:MII_PR_Seltene_Blutgruppe |
...
1. Der Suchparameter "code" MUSS unterstützt werden:Beispiele:`GET [base]/Observation?code=http://loinc.org|882-1`Anwendungshinweise: Weitere Informationen zur Suche nach "code" finden sich in der FHIR-Basisspezifikation - Abschnitt "token".
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-seltene-blutgruppe.csv), [Excel](../StructureDefinition-mii-pr-seltene-blutgruppe.xlsx), [Schematron](../StructureDefinition-mii-pr-seltene-blutgruppe.sch) 
