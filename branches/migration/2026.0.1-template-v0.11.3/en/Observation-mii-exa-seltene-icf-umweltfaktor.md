# ICF example — environmental factor (chapter e), facilitator - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ICF example — environmental factor (chapter e), facilitator**

## Example Observation: ICF example — environmental factor (chapter e), facilitator
