...
## Example ResearchSubject: Beispiel Registerteilnahme — ERN EURO-NMD
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-seltene/StructureDefinition/mii-pr-seltene-registerteilnahme|2026.0.1"]
  },
  "extension" : [{
