...
* `fix` value set `mii-vs-seltene-clinical-diagnosis-category` corrected and **bound for the first time**. Four of its eight codes were wrong or non-existent: `363358000` stood for "Clinical finding" and is **Malignant neoplasm of lung**, `47367009` stood for "Syndrome" and is **Exocrine pancreatic insufficiency**, `84757009` stood for "Rare disease" and is **Epilepsy**, `381406004` does not exist. Two were replaced (`404684003`, `66091009`); SNOMED CT has no generic concept for "Syndrome" or "Rare disease", so those were dropped rather than bent onto something similar. The value set had existed since 2025-08-07 and was **never bound to a profile**, although the guide has described the categorisation for a year; `mii-pr-seltene-clinical-diagnosis.category` now binds it `extensible`
