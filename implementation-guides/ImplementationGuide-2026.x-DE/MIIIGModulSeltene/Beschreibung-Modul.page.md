...
Wie die anderen Implementierungsleitfäden (IG) der Module des MII-KDS soll das **Modul Seltene Erkrankungen** in den Datenintegrationszentren bei der Aufbereitung von vorhandenen Patientendaten aus dem Versorgungskontext unterstützen. Das Erweiterungsmodul baut bewusst auf bereits vorhandenen Modulen des MII-KDS auf.  Bereits modellierte Datenelemente und Strukturen werden, wo möglich, wiederverwendet, anstatt sie zu duplizieren. Das Erweiterungsmodul SE versteht sich als Konvolut bzw. Kompositorium, das verschiedene relevante Datenelemente aus unterschiedlichen Modulen integriert, ohne die zugrunde liegenden Module vollständig zu übernehmen. Es wurde wegen inhaltlicher Überschneidungen von Merkmalen eine merkliche Überlappung mit Implementierungsregeln der Module **DIAGNOSE, SYMPTOM/PHÄNOTYP** und **MOLEKULARGENETIK** umgesetzt.
