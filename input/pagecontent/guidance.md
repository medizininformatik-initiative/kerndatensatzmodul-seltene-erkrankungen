...
* **[Datasets and Descriptions](logical-models.html)** — the module's data
  ...
  *Artifacts → Logical Models*; neither Artifacts-Summary anchor is usable as
  a link target — see
  [`docs/page-structure.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-seltene-erkrankungen/blob/main/docs/page-structure.md) in this repository.)
