<!-- TODO:REVIEW machine translation of source pages index.md + module-description.md (de) — Migration 2026-08-28, page-map.tsv -->
...
* Be available as KDS module "Rare Diseases" of the <a href="https://www.medizininformatik-initiative.de/de/der-kerndatensatz-der-medizininformatik-initiative" target="_blank">MII KDS</a> via the *data integration centers* in the MII and in the NUM for **distributed and central analyses**,
* Be transmitted as <a href="https://eu-rd-platform.jrc.ec.europa.eu/sites/default/files/CDS/JRC-2018-00192-00-00-DE-TRA-00-Final.pdf" target="_blank">ERDRI CDS</a> (with the consent of those affected) to the relevant *registries* of the European Reference Networks,
* Be transmitted as <a href="https://www.narse.de/fileadmin/narse/2025-01-30_NARSE_Datenelemente_DE_V1.2.pdf" target="_blank">NARSE data set</a> (with the consent of those affected) to the *central NARSE* for its application scenarios,
...
* Promote the **networking of affected persons** via the <a href="https://forschen-fuer-gesundheit.de/" target="_blank">Research Data Portal for Health (FDPG)</a> of MII/NUM, the <a href="https://vp.ejprarediseases.org/" target="_blank">Virtual Platform of the European Rare Disease Research Alliance (ERDERA)</a> and further platforms accredited by the data holders, support **finding patients for research projects**, and advance the **consideration** of rare diseases in German and European **health reporting**.
