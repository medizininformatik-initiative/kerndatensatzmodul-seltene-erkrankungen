...
This page lists the FHIR profiles of the **Seltene Erkrankungen** module. As a
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-seltene-erkrankungen/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
