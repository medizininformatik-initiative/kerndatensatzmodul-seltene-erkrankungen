...
[`docs/recipes/add-translation.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-seltene-erkrankungen/blob/main/docs/recipes/add-translation.md) in this repository.
...
> **Known gap:** the last row. Artefact titles and descriptions reach the reader
> from the resources themselves, not from the page sources, so translating them
> means adding translation units for each element rather than editing a page. The
> module has not done this, and a reader on `/de/` therefore meets English text on
> every artefact page. This is a gap in coverage, not in correctness: the German
> narrative pages explain every artefact, and the codes and bindings are
> language-independent.
{: .ig-highlight .ig-highlight-grey}

One note on provenance: the predecessor guide on Simplifier was written in German.
The chapters carried over from it were machine-translated into English during the
migration and are under editorial review, so the German wording is the older of the
two for those pages.
