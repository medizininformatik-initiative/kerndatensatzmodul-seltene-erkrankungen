...
* familienanamnese 0..* BackboneElement "Familienanamnese"
  ...
  * familienmitgliedVerstorben 0..1 code "Familienmitglied verstorben" "Gibt an, ob das Familienmitglied verstorben ist."
  // Ergaenzt 2026-09-02: beide Datenpunkte werden von mii-pr-seltene-familienanamnese
  // bereits gefuehrt, das Modell kannte sie nicht — die Mappings zeigten daher ins Leere.
  * todDurchSE 0..1 code "Tod durch seltene Erkrankung" "Gibt an, ob die seltene Erkrankung zum Tod des Familienmitglieds beigetragen hat. Abzugrenzen von familienmitgliedVerstorben, das nur den Tod als solchen festhaelt."
...
* persoenlicheInfosIndexpatient -> "persoenlicheInfosIndexpatient"
