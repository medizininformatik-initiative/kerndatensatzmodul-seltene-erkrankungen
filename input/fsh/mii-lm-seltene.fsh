...
* anamneseUndDiagnostik 0..* BackboneElement "Diagnose"
  ...
  * phaenotypisierung 0..* BackboneElement "Phänotypisierung"
    * hpoTerm 0..* code "HPO-Term des Symptoms" "Phänotypisierung des SE-Patienten mittels HPO-Term (Human Phenotype Ontology) oder anderer Terminologien (SNOMED CT, ICD-10, LOINC)."
    ...
    * hpoStatus 0..1 code "Status HPO-Term" "Status oder Schweregrad des Phänotyps (Present/Absent/Severity)."
    * hpoVersion 0..1 code "Version HPO-Term" "Kennzeichnung der genutzten Version des ausgewählten HPO-Terms."
    ...
    * verlaufSymptom 0..1 code "Verlauf Symptom" "Änderung des Verlaufs des Symptoms seit der vorherigen Untersuchung."
  ...
  * genDiaFehlendePenetranz 0..* code  "Genetische Diagnose mit fehlender Penetranz" "Gibt an, ob bei einer genetischen Diagnose die Penetranz (Wahrscheinlichkeit Genotyp bildet Phänotyp aus) fehlt"
...
* koerperlicheUntersuchung 0..* BackboneElement "Körperliche Untersuchung"
  ...
  * taillenumfang 0..* BackboneElement "Taillenumfang"
    * taillenumfang 0..1 decimal "Taillenumfang in cm" "Taillenumfang des SE-Patienten in cm. Abzugrenzen vom Bauchumfang, der auf Nabelhöhe gemessen wird."
...
* familienanamnese 0..* BackboneElement "Familienanamnese"
  * verwandtschaftsverhaeltnis 0..1 code "Verwandtschaftsverhältnis" "Biologisches Verwandtschaftsverhältnis des Familienmitglieds zum Indexpatienten."
  ...
  * penetranz 0..1 code "Penetranz" "Gibt an, ob bei fehlender klinscher Penetranz (Wahrscheinlichkeit Genotyp bildet Phänotyp aus) die genetische Diagnose vorliegt."
...
* therapieForschung 0..* BackboneElement "Therapie und Forschung"
  ...
  * therapie 0..* BackboneElement "Therapie"
    ...
    * durchgefuehrteTherapie 0..* code "Durchgeführte Therapie" "Tatsächlich durchgeführte Therapie des SE-Patienten (mit oder ohne Studie mit heilender Intention)."
