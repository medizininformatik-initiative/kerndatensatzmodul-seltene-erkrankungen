...
> **Festlegung (2026-09-04).** Dieses Modul definiert **keine** Laborprofile; die
> Fallbeispiele führen deshalb blanke `Observation`-Ressourcen mit
> `category = laboratory`. Sollten künftig Laborparameter ins Modul aufgenommen
> werden, **erben sie vom MII-Modul Laborbefund** und werden nicht hier aus
> `Observation` heraus profiliert. Der erste Schritt dazu ist,
> `de.medizininformatikinitiative.kerndatensatz.laborbefund` als Abhängigkeit
> aufzunehmen. Dieselbe Arbeitsteilung gilt für Variantenbefunde, die in den
> **Molekulargenetischen Befund** gehören — jenes Modul *ist* bereits
> Abhängigkeit, seine Profile werden referenziert statt kopiert.
