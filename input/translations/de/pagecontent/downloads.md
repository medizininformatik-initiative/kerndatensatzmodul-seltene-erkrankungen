...
* [ImplementationGuide-Ressource](ImplementationGuide-mii-ig-seltene.html)
...
Über die oben aufgeführten hinaus bietet das Modul keine Downloads an. Jeder Link
dieser Seite wurde gegen den publizierten Build geprüft; die Beispiel-Bundles der
beiden Fallbeispiele stecken in `examples.json.zip` und `examples.xml.zip`.
