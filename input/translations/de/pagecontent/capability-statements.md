<!-- DE-Uebersetzungsseite; Quelle(n): capability.md — Migration 2026-08-28, page-map.tsv -->
...
Das vollständige CapabilityStatement ist in der Artefakt-Übersicht abrufbar (siehe [Artifacts](artifacts.html)).
