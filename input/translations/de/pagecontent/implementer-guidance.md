...
In Frankreich basiert die vorrangige Strategie der Datenerfassung für die mehrfache lokale und übergreifende Datennutzung, der sogenannte Verbundene Modus (mode connecté), auf der Interoperabilität von Krankenhausinformationssystemen (KIS) mit dem Zentralregister BNDMR und seinen Zugängenm siehe: [Le mode connecté avec le dossier patient](https://www.bndmr.fr/participer/mode-connecte/).
