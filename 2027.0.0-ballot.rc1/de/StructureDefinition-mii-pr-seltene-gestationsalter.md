# MII PR SE Gestationsalter bei Geburt - MII IG Kerndatensatz-Modul Seltene Erkrankungen v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR SE Gestationsalter bei Geburt**

## Ressourcenprofil: MII PR SE Gestationsalter bei Geburt 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-seltene/StructureDefinition/mii-pr-seltene-gestationsalter | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-09 | *Maschinenlesbarer Name*:MII_PR_Seltene_Gestationsalter |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-seltene-gestationsalter.csv), [Excel](../StructureDefinition-mii-pr-seltene-gestationsalter.xlsx), [Schematron](../StructureDefinition-mii-pr-seltene-gestationsalter.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "mapping" : [{
        "identity" : "SE-LogicalModel",
        "map" : "perinatal.gestationsalter",
        "comment" : "Gestationsalter bei Geburt"
      }]
    },
    {
