...
```bash
# Navigate to project
cd /Users/thome/code/fhir-profiling/kerndatensatzmodul-seltene-erkrankungen

# Publish package
simplifier push \
  --project [SIMPLIFIER_PROJECT] \
  --version [VERSION] \
...
1. Navigate to https://simplifier.net/[SIMPLIFIER_PROJECT]
...
3. Test package installation:
   ```bash
   fhir install de.medizininformatikinitiative.kerndatensatz.seltene@[VERSION]
   ```
...
**URL**: https://simplifier.net/[SIMPLIFIER_PROJECT]/~packages
**Install Command**:
  fhir install de.medizininformatikinitiative.kerndatensatz.seltene@[VERSION]
```
