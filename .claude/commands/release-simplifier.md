...
2. Navigate to: https://simplifier.net/[SIMPLIFIER_PROJECT]
...
1. Verify package appears at: https://packages.simplifier.net/de.medizininformatikinitiative.kerndatensatz.seltene
2. Download the `.tgz` package for GitHub release upload
3. Record package URL for documentation
...
```
For this project: `fhir project link [SIMPLIFIER_PROJECT] --strategy TakeLocal`
...
```
# MII Seltene Erkrankungen 2026.0.0

[Full Release Notes](https://simplifier.net/guide/mii-ig-seltene-erkrankungen-v2026-de/ReleaseNotes)
...
**Single Source of Truth**: The IG Release Notes page should be the authoritative source. Copy its content to `package.json` description for Simplifier registry visibility.
...
```
Example: `fhir publish-package de.medizininformatikinitiative.kerndatensatz.seltene.2026.0.0.tgz`
